...
class UI:
    ...
    def _show_welcome_view(self):
        ...
        self._current_view = WelcomeView(self._root, self._show_create_bingo_sheets_view, self._show_play_bingo_view)
        self._current_view.pack()

    def _show_play_bingo_view(self):
        game_name = self._current_view.variable.get()
        self._hide_current_view()
        self._current_view = PlayBingoView(self._root, self._play, game_name, self._show_welcome_view)
        self._current_view.pack()
